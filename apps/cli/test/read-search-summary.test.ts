...
const request = (previousToolResults: ModelRequest['previousToolResults'] = []): ModelRequest => ({ runId: '11111111-1111-4111-8111-111111111111' as Uuid, task: 'x', project: { id: 'project' }, context: [{ path: 'README.md', content: '# R1 fixture\n\nMalý TypeScriptový projekt pro ověření čtení zdrojů a hledání symbolů.\n', contentHash: 'a'.repeat(64), byteLength: 7, reason: 'explicit_reference' }], tools: [], previousToolResults });
...
describe('read-search-summary scenario', () => {
  it('requires the exact ordered search audit and greeting file evidence', () => {
    ...
    const read = { ok: true as const, callId: '00000000-0000-4000-8000-000000000002' as Uuid, output: { path: 'src/greeting.ts', content: 'export function formatGreeting(name: string): string {\n  return `Ahoj, ${name}!`;\n}\n', startLine: 1, endLine: 4, totalLines: 4, truncated: false, contentHash: '03eff74d58afc51d8466df100644f491bbf6716854b785848c0650053e4774c2' } };
